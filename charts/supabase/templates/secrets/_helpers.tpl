...
{{- $isValid := "false" -}}
{{- if or (and .Values.secret.s3.keyId .Values.secret.s3.accessKey) (and .Values.secret.s3.secretRef .Values.secret.s3.secretRefKey.keyId .Values.secret.s3.secretRefKey.accessKey) -}}
{{- printf "true" -}}
{{- else -}}
{{- printf "false" -}}
{{- end -}}
